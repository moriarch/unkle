...
import {Text, Linking, View,TextInput,KeyboardAvoidingView, ScrollView} from 'react-native';
    ...
    <KeyboardAvoidingView
     ...
     keyboardVerticalOffset="20"
      ...
      <Text style={{
          ...
          <TextInput  style={input} placeholder="Name" placeholderTextColor="#404040"/>
          <TextInput  style={input} placeholder="Name" placeholderTextColor="#404040"/>
          <TextInput  style={input} placeholder="Name" placeholderTextColor="#404040"/>
          <TextInput  style={input} placeholder="Name" placeholderTextColor="#404040"/>
          </View>
